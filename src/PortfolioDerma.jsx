        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-100 group hover:bg-teal-50 transition-all">
              ...
              <p className="text-slate-400 text-xs font-medium uppercase tracking-widest italic"> 최우수연구자상, 대한한방병원협회장상 등</p>
            </div>
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-100 group hover:bg-teal-50 transition-all">
            ...
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-100 group hover:bg-teal-50 transition-all">
              ...
              <p className="text-slate-400 text-xs font-medium uppercase tracking-widest italic"> 넷마블, LG, 현대중공업 등</p>
            </div>
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-100 group hover:bg-teal-50 transition-all">
              <span className="text-5xl font-black text-teal-600 block mb-4">리더십</span>
              <p className="text-slate-800 font-bold mb-1">임원 활동</p>
              <p className="text-slate-400 text-xs font-medium uppercase tracking-widest italic">전국단위단체 임원, 동아리 임원 등</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-12 rounded-[3rem] shadow-sm border border-slate-200 bg-teal-50/30">
              ...
              <p className="text-slate-500 leading-relaxed break-keep font-medium">
                첫 3개월, 원장님의 진료 흐름을 방해하지 않겠습니다. 한의원 시스템, 상담과 술기를 빠르게 습득하여, 실질적인 진료 분담이 되는 수준으로 올라가겠습니다.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="bg-white/5 p-12 rounded-[3rem] border border-white/10 hover:border-teal-400/50 transition-all">
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-6 font-medium">
                기업 협업, 조교 경험, 의료봉사단 부회장, 학술동아리 교육위원, 동아리 회장.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                n: '피부질환·여드름', 
                tag: '#술기_압출_장비', 
                desc: '피부 질환에 관심이 깊습니다. 압출부터 CO2 등 장비 활용 술기가 중요한 분야에 관심이 있습니다.' 
              }, 
              { 
                n: '피부-내과 기전', 
                tag: '#SCI_내치_전문성', 
                desc: '좌금환이 위장관 운동에 영향을 미치는 기전을 SCI 논문으로 규명했습니다. 피부 질환의 내적 원인을 논리적으로 설명하고 싶습니다.'
              }, 
              { 
                n: '만성 질환', 
                tag: '#장기_순응도_공감', 
                desc: '장기 치료가 필요한 분들께 데이터 기반 예후 제시, 사회 경험으로 기른 공감 능력을 발휘하여, 불안을 해소하고 완치까지 동행하는 신뢰를 쌓고 싶습니다.' 
              }, 
              { 
                n: '다이어트·미용', 
                tag: '#토탈_뷰티_케어', 
              ...
              { 
                n: '근골격·추나', 
                tag: '#기본_소양', 
                desc: '여드름 진료 외에도 내원하시는 교통사고 및 일반 침구 환자분들을 위해 정확한 진단과 추나 시술로 병원 운영에 기여하겠습니다.'
              }
            ].map((item, i) => (
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-8 border-b border-slate-200 pb-16">
              ...
              <div className="md:w-3/4">
                <h4 className="text-3xl font-[900] text-[#0f172a] mb-3"> 소화장애 SCI & KCI 논문 제1저자 게재</h4>
                <p className="text-xl text-slate-500 font-bold mb-6">석사연구원 | 부산대 한의전 양생기능의학교실</p>
                <p className="text-2xl text-teal-600 font-black flex items-start gap-3 italic leading-snug">
                  ...
                  좌금환 기전을 탐구했던 것처럼, 환자에게 처방 이유를 명확히 설명하는 성향<br className="hidden md:block"/>→ 피부질환에 있어 전인적 관리의 필요성을 논리적으로 강조하고 싶습니다.
                </p>
              </div>
            </div>

            {/* 2. 피부 외치 및 실무 역량 (신규 추가) */}
            <div className="flex flex-col md:flex-row gap-8 border-b border-slate-200 pb-16">
              <div className="md:w-1/4 text-2xl font-black text-slate-300 italic tracking-tighter">2024-2025</div>
              <div className="md:w-3/4">
                <h4 className="text-3xl font-[900] text-[#0f172a] mb-3">피부 한의원 참관 및 아토피 스터디</h4>
                <p className="text-xl text-slate-500 font-bold mb-6">
                  피부학술동아리 | 부산대학교
                </p>
                <p className="text-2xl text-teal-600 font-black flex items-start gap-3 italic leading-snug">
                  <span className="text-3xl mt-[-4px]"></span> 
                  아토피/만성 피부 질환의 시기별·양상별 치료와 외치 학습 <br className="hidden md:block"/> 
                  → 아토피 및 장기 환자들의 장기적 치료에 적극적이고 긍정적인 상담으로 끈기있게 임하겠습니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 border-b border-slate-200 pb-16">
              ...
              <div className="md:w-3/4">
                <h4 className="text-3xl font-[900] text-[#0f172a] mb-3">한의전 유일 봉사동아리 기획 및 예산 총괄</h4>
                <p className="text-xl text-slate-500 font-bold mb-6">
                  부회장 | 부산대학교 동제의료봉사단
                </p>
                <p className="text-2xl text-teal-600 font-black flex items-start gap-3 italic leading-snug">
                  <span className="text-3xl mt-[-4px]"></span> 
                  120명 규모 조직, 연간 예산 및 금융·회계 업무 전담 : 물품 구매, 현장 운영 기획 <br className="hidden md:block"/> 
                  → 시스템의 중요성을 알기에, 한의원의 시스템을 빠르게 흡수하고 한의원에 기여하겠습니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 border-b border-slate-200 pb-16">
              ...
              <div className="md:w-3/4">
                <h4 className="text-3xl font-[900] text-[#0f172a] mb-3">빅데이터 인턴, 알고리즘 개발 최종입사 제의</h4>
                <p className="text-xl text-slate-500 font-bold mb-6">인턴, 연구원 | 넷마블, LG, 현대중공업</p>
                <p className="text-2xl text-teal-600 font-black flex items-start gap-3 italic leading-snug">
                  <span className="text-3xl mt-[-4px]"></span> 
                  불규칙한 업무 강도에 익숙함, 성실한 태도, 빠르고 정확한 업무 완결성으로 최종 입사 제의 <br className="hidden md:block"/> 
                  → 야간진료가 많은 환경에서도 지치지 않는 체력과 성실함으로 진료실을 지키겠습니다.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-5">
              ...
              <div className="bg-white rounded-[3rem] p-10 border border-slate-100 shadow-sm h-full">
                <div className="space-y-10">
                  {[
                    { y: '2026', t: '최우수연구자상', o: '부산대학교' },
                    { y: '2026', t: '대한한방병원협회장상', o: '부산대학교' },
                    { y: '2022-2025', t: '성적우수장학금', o: '부산대학교' },
                    { y: '2020', t: '전민근연구실장학금', o: '포항공과대학교' }
                  ].map((award, i) => (
